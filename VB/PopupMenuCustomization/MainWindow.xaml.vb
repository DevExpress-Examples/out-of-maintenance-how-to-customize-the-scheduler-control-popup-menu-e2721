    ...
    Partial Public Class MainWindow
        ...
        Private Sub schedulerControl1_PopupMenuShowing(ByVal sender As Object, ByVal e As SchedulerMenuEventArgs)
            ...
            If e.Menu.Name = SchedulerMenuItemName.DefaultMenu Then
                For i As Integer = 0 To e.Menu.ItemLinks.Count - 1
                    Dim menuItemLink As BarButtonItemLink = TryCast(e.Menu.ItemLinks(i), BarButtonItemLink)
                    If menuItemLink IsNot Nothing Then
                        Dim menuItem As SchedulerBarItem = TryCast(menuItemLink.Item, SchedulerBarItem)
