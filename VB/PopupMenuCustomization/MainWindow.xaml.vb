...
Namespace CustomMenu
    ...
    Public Partial Class MainWindow
        ...
        Private Sub Window_Loaded(ByVal sender As Object, ByVal e As RoutedEventArgs)
            Dim apt As Appointment = Me.schedulerControl1.Storage.CreateAppointment(AppointmentType.Normal, Date.Now, Date.Now.AddHours(1.5), "Test Appointment")
            apt.LabelKey = 1
            Me.schedulerControl1.Storage.AppointmentStorage.Add(apt)
            Me.schedulerControl1.ActiveView.GotoTimeInterval(New TimeInterval(Date.Now.AddHours(-2), Date.Now.AddHours(-1)))
        End Sub
...
'#Region "#PopupMenuShowing"
        Private Sub schedulerControl1_PopupMenuShowing(ByVal sender As Object, ByVal e As SchedulerMenuEventArgs)
            ...
            If Equals(e.Menu.Name, SchedulerMenuItemName.DefaultMenu) Then
                For i As Integer = 0 To e.Menu.Items.Count - 1
                    Dim menuItem As SchedulerBarItem = TryCast(e.Menu.Items(i), SchedulerBarItem)
                    If menuItem IsNot Nothing Then
                        If menuItem IsNot Nothing AndAlso Equals(menuItem.Name, SchedulerMenuItemName.NewAllDayEvent) Then
                ...
                Dim myMenuItem As BarButtonItem = New BarButtonItem()
